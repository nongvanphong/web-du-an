  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex flex-col gap-5 mt-5">
        <div className="w-full h-24 bg-orage-100-ct rounded-3xl flex items-center">
          <img src={food} alt="food" className="w-24 h-24" />
          <span className="ml-24 text-xl text-white">
            Quản lí danh sách món ăn của bạn
          </span>
        </div>
        <div className="w-full h-24 bg-blude-30-ct rounded-3xl flex items-center">
          <img src={drink} alt="drink" className="w-24 h-24" />
